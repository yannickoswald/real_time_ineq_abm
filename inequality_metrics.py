...
def find_wealth_groups(agents_list, total_wealth):
    ...
    and the wealth share, of the top1%, 10%, middle 40%, bottom 50%, and bottom 10% '''
    ...
    ## number of agents in middle 40%
    agents_per_middle40 = agents_per_percentile*40
    ## number of agents in bottom 50%
    agents_per_bottom50 = agents_per_percentile*50
    ##### required to compute middle 40%
    ...
    middle40 = agents_list[agents_per_top30:len(agents_list)-agents_per_top30]
    ...
    share_middle40 = middle40_wealth / total_wealth
    share_bottom50 = bottom50_wealth / total_wealth
    
    
    return [[top1_wealth, top10_wealth,  middle40_wealth, bottom50_wealth]
            ,[share_top1, share_top10, share_middle40, share_bottom50]]
